...
import logoAsset from "@/assets/nayesha-healthcare-logo.webp.asset.json";
  ...
  return (
    <div className="min-h-screen overflow-x-clip bg-background text-foreground">
      ...
      <header className="site-header">
        <Link to="/" className="logo-link" aria-label="Nayesha Healthcare home"><img src={logoAsset.url} alt="Nayesha Healthcare" /></Link>
      ...
      <footer className="site-footer">
        <div className="footer-lead"><img src={logoAsset.url} alt="Nayesha Healthcare" /><p>Thoughtful pediatric care for every chapter of childhood.</p></div>
